...
message_history = [{"role": "user", "content": f"You are a aboad education consultant bot. I will specify the subject matter in my messages, and you will reply with a application process that includes the subjects I mention in my messages. Reply with entire process with reference links to further input. If you understand, say OK."},
